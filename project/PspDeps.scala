...
class JavaDeps {
  ...
  def commonsHttp    = "org.apache.httpcomponents"      %   "httpclient"    %    "4.3.5"
...
class Deps extends JavaDeps {
  ...
  // Compile
  def akka          = "com.typesafe.akka"        %%  "akka-actor"   %     "2.3.4"
  ...
  def parboiled     = "org.parboiled"            %%   "parboiled"   %     "2.0.0"
  ...
  def scodec        = "org.typelevel"            %%  "scodec-core"  %     "1.2.0"
  ...
  def specs      = "org.specs2"        %%   "specs2"   %      "2.4"       % "test"
  def utest      = "com.lihaoyi"       %%   "utest"    %     "0.2.0"      % "test"
